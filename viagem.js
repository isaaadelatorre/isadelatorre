...
function comprarPassagem() {
  ...
  if (!mapaAssentos[assento] && assento.match(/^[AB][1-9]|1[0-2]$/)) {
    ...
    console.log('\nAssento ocupado ou não disponivél');
  }
}
...
function consultarVoos() {
  ...
  console.log('1- Presidente Prudente --> Dubai');
  console.log('2- Presidente Prudente --> Ceará');
  console.log('3- Presidente Prudente --> São Paulo');
  console.log('4- Presidente Prudente --> Nova iorque');
}
...
function emitirTicket() {
  ...
  console.log('===============================');
  console.log('      Companhia Aérea Isa airlines      ');
  console.log('===============================');
  console.log(`Nome: ${nome} ${sobrenome}`);
  console.log(`Idade: ${idade}`);
  console.log(`Assento: ${assento}`);
